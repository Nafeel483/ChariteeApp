    ...
    return (
      <View style={Styles.mainConatiner}>
        ...
        <View style={Styles.mainContainer}>
          ...
          <Text style={Styles.description}>{"You can change the supported amount or cancel your subscription at any time."}</Text>
            ...
            <View style={Styles.showPaymentWrapper}>
              <View style={{ flexDirection: 'row', marginLeft: 15 }}>
                ...
                <View style={Styles.mainProfileWrapper}>
                  <Image source={Images.Emoji} style={Styles.mainProfileWrapper1} />
                </View>
